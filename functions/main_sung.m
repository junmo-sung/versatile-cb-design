function [Hest_OMP, Hest_BPDN, Hest_IHT, Hest_LS, H_hat_or, NMSE_LS, NMSE_OMP, NMSE_BPDN, NMSE_IHT, NMSE_OR] = main_sung(SP, BF)
...
noise_combined = BF.WBarDiag'*SP.noiseMatrix;
